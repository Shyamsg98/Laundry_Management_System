...
<head>
    ...
    <title>Laudry Status</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-5">
        <div class="container-fluid">
          <a class="navbar-brand" href="customer_panel.php" style="font-size: 22px;">Welcome to the Customer Panel</a>
          
            <ul class="navbar-nav  mb-2 mb-lg-0">
             <li class="nav-item">
               <a class="nav-link" href="front_page.html">
