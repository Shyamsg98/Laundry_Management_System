...
if(isset($_POST['submit'])){
    ...
    <td><a href="set_status.php?id=<?php echo "$cid"; ?>> <button type="text/javascript" ><?php echo $L_status; ?></button> </td> 
    <td><a href="set_payment.php?id=<?php echo "$cid"; ?>> <button type="text/javascript"><?php echo $P_status; ?></button> </td>   
    <?php
      }
    }
    else{
