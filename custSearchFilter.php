...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-5">
        ...
        <a class="navbar-brand" href="dashboard_test.php" style="margin-left:20px;">Admin panel</a>
    ...
    <div class="container">
        ...
        <div class="row">
            <form class="form-horizontal" action="" method="post">
              ...
              <div class="row mb-5">
                <center><input name="submit" type="submit" value="SEARCH" class="form-control btn btn-primary" id="inputPassword3" style="width:100%;"/></center>
              </div>
...
if(isset($_POST['submit'])){
    ...
    if($num>0){
            ...
            while($row=mysqli_fetch_assoc($data)){
                ...
                <td><a href="cust_edit.php?id=<?php echo "$cid"; ?>> <button type="text/javascript" class='btn btn-primary'>Edit</button> </td> 
                <td><a href="cust_delete.php?id=<?php echo "$cid"; ?>> <button type="text/javascript" class='btn btn-danger'>Delete</button></td>
