...
while($row=mysqli_fetch_array($bill)){
  ...
  echo "<tr>";
    ...
    echo "<td>";
     ?>
     <a href="set_status.php?id=<?php echo $row["cid"]; ?>">  
     <button type="text/javascript" class='btn-paid'>
      <?php echo $L_status;  ?>
      </button>
      </a>
      <?php 
      ...
      echo "<td>"; 
      ?> 
    <a href="set_payment.php?id=<?php echo $row["cid"]; ?>"> 
    <button type="text/javascript" class='btn btn-danger'>
      <?php 
      echo $P_status; 
       ?></button>
      </a>
